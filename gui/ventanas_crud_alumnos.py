...
class FrameAlumnos(ttk.Frame):
    def __init__(self, parent, pers=None):
        ...
        # usar persistencia si se pasa, sino crear una por defecto
    ...
    def build_ui(self):
        # Formulario alta
        form = ttk.Labelframe(self, text="Crear / Modificar Alumno", padding=10)
